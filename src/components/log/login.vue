<template>
  <div class="content">
    ...
    <b-form-input type="password" id="text-password" v-model="password" aria-describedby="password-help-block"></b-form-input>
 ...
 <transition name="error"  mode="out-in">
    <b-alert show variant="danger" v-if="error">{{this.error}}</b-alert>
    </transition>
  </div>
</template>
           ...
           if(this.email!=''&&this.password!=''){
               ...
               this.logIn(payload);
                  setTimeout(() => {
                    ...
                    this.error = 'Please Enter Valid username OR Passowrd';
                    }
               }, 800); 
           }else{
